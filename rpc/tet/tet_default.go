...
func AddToken(ctx context.Context, req *agent.AddTokenReq, callOptions ...callopt.Option) (resp *agent.AddTokenRes, err error) {
	resp, err = defaultClient.AddToken(ctx, req, callOptions...)
	if err != nil {
		klog.CtxErrorf(ctx, "AddToken call failed,err =%+v", err)
		return nil, err
	}
	return resp, nil
}

func DeleteToken(ctx context.Context, req *agent.DeleteTokenReq, callOptions ...callopt.Option) (resp *agent.DeleteTokenRes, err error) {
	resp, err = defaultClient.DeleteToken(ctx, req, callOptions...)
	if err != nil {
		klog.CtxErrorf(ctx, "DeleteToken call failed,err =%+v", err)
		return nil, err
	}
	return resp, nil
}

func GetToken(ctx context.Context, req *agent.GetTokenReq, callOptions ...callopt.Option) (resp *agent.GetTokenRes, err error) {
	resp, err = defaultClient.GetToken(ctx, req, callOptions...)
	if err != nil {
		klog.CtxErrorf(ctx, "GetToken call failed,err =%+v", err)
		return nil, err
	}
	return resp, nil
}
